...
'<embed name="'+this.config.fid+'" id="'+this.config.fid+'" src="'+this.config.swf+'"';d+=' width="'+this.config.width+'" height="'+this.config.height+'" bgcolor="'+this.config.bgcolor+'"';d+=' quality="high" FlashVars="id='+escape(this.config.id)+"&fid="+escape(this.config.fid)+"&vol="+this.config.volume+'"';d+=' allowScriptAccess="always"';d+=' type="application/x-shockwave-flash" pluginspage="http://web.archive.org/web/20220309125800/http://www.macromedia.com/go/getflashplayer" />';this.element.html(d)}else this.element.html("<p>Flash 8 or above is not installed. <a href='http://web.archive.org/web/20220309125800/http://get.adobe.com/flashplayer'>Get Flash!</a></p>");
...
/*
     FILE ARCHIVED ON 12:58:00 Mar 09, 2022 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.012
  cdx.remote: 11.429
  LoadShardBlock: 72.925 (3)
  PetaboxLoader3.datanode: 89.506 (4)
  PetaboxLoader3.resolve: 64.763 (2)
  load_resource: 90.251
*/